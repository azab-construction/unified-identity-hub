    ...
    >
      <div className="glass-strong rounded-2xl shadow-card border border-border/50 p-6 text-center">
        ...
        <div className="flex gap-3">
          <button className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-border bg-card hover:bg-muted hover:border-primary/30 transition-all duration-200 text-sm font-medium text-foreground hover:shadow-sm">
