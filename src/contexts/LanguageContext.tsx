...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    "auth.providerDisabled": "هذا المزوّد غير متاح حالياً",
    "auth.tabEmail": "بريد إلكتروني",
    "auth.tabPhone": "هاتف",

    // Auth Settings Page
    "settings.title": "إعدادات المصادقة",
    "settings.subtitle": "إدارة مزوّدي تسجيل الدخول وحالة كل قناة",
    "settings.providers": "مزوّدو المصادقة",
    "settings.providers.desc": "تتم إدارة هذه المزوّدين من لوحة Lovable Cloud",
    "settings.status.active": "مفعّل",
    "settings.status.inactive": "معطّل",
    "settings.status.unsupported": "غير مدعوم",
    "settings.status.comingSoon": "قريباً",
    "settings.security": "إعدادات الأمان",
    "settings.security.hibp": "حماية كلمات المرور المسرّبة",
    "settings.security.hibp.desc": "فحص كلمات المرور ضد قاعدة بيانات HIBP",
    "settings.security.confirm": "تأكيد البريد الإلكتروني تلقائياً",
    "settings.security.confirm.desc": "تخطي خطوة التحقق من البريد عند التسجيل",
    "settings.openCloud": "فتح لوحة Lovable Cloud",
    "settings.note.title": "ملاحظة هامة",
    "settings.note.body": "Facebook و WhatsApp غير مدعومين حالياً في نظام المصادقة. واتساب لا يقدم تسجيل دخول OAuth، أما Facebook فيتطلب ربط Supabase خارجي.",
    "settings.method.email": "البريد الإلكتروني (OTP)",
    "settings.method.phone": "رقم الهاتف (SMS)",
    "settings.method.google": "تسجيل الدخول بـ Google",
    "settings.method.apple": "تسجيل الدخول بـ Apple",
    "settings.method.facebook": "تسجيل الدخول بـ Facebook",
    "settings.method.whatsapp": "تسجيل الدخول بـ WhatsApp",
  },
  en: {
    // Navbar
    "nav.home": "Home",
    ...
    // Auth Providers
    "auth.phone.login": "Sign in with phone",
    "auth.phone.placeholder": "+1 555 123 4567",
    "auth.phone.send": "Send verification code",
    "auth.facebook": "Facebook",
    "auth.whatsapp": "WhatsApp",
    "auth.comingSoon": "Coming soon",
    "auth.providerDisabled": "This provider is not available yet",
    "auth.tabEmail": "Email",
    "auth.tabPhone": "Phone",

    // Auth Settings Page
    "settings.title": "Authentication Settings",
    "settings.subtitle": "Manage sign-in providers and channel status",
    "settings.providers": "Auth Providers",
    "settings.providers.desc": "These providers are managed from the Lovable Cloud dashboard",
    ...
    "settings.security.hibp": "Leaked password protection",
    "settings.security.hibp.desc": "Check passwords against the HIBP database",
    "settings.security.confirm": "Auto-confirm email",
    "settings.security.confirm.desc": "Skip email verification step on signup",
    "settings.openCloud": "Open Lovable Cloud",
    "settings.note.title": "Important note",
    "settings.note.body": "Facebook and WhatsApp are not currently supported. WhatsApp does not provide OAuth login, while Facebook requires connecting an external Supabase project.",
    "settings.method.email": "Email (OTP)",
    "settings.method.phone": "Phone (SMS)",
    "settings.method.google": "Google Sign-In",
    "settings.method.apple": "Apple Sign-In",
    "settings.method.facebook": "Facebook Sign-In",
    "settings.method.whatsapp": "WhatsApp Sign-In",
  },
};
