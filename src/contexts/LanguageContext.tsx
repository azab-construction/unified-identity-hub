...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    "otp.login.subtitle": "أدخل بريدك الإلكتروني لتلقي رمز التحقق",
    "otp.login.btn": "إرسال رمز التحقق",
    "otp.login.sending": "جارٍ الإرسال...",
    "otp.check.title": "تحقق من بريدك الإلكتروني",
    "otp.check.subtitle": "أرسلنا رمز التحقق إلى",
    "otp.check.btn": "إدخال رمز التحقق",
    "otp.check.resend": "إعادة إرسال الرمز",
    "otp.check.resent": "تم إعادة الإرسال",
    "otp.check.wrongEmail": "بريد خاطئ؟ عُد وأعد المحاولة",
    "otp.verify.title": "أدخل رمز التحقق",
    "otp.verify.subtitle": "لقد أرسلنا رمزًا إلى بريدك الإلكتروني",
    "otp.verify.btn": "تأكيد",
    "otp.verify.verifying": "جارٍ التحقق...",
    "otp.verify.resend": "إعادة إرسال الرمز",
    "otp.verify.error": "الرمز غير صحيح. حاول مرة أخرى.",
    "otp.success.title": "تم التحقق بنجاح",
    ...
    "azabot.attachFile": "إرفاق ملف",
    "azabot.takePhoto": "تصوير العطل",
    "azabot.downloadChat": "تحميل المحادثة",
    "azabot.clearChat": "مسح المحادثة",
    "azabot.services": "روابط الخدمات",
    "azabot.serviceMain": "الموقع الرئيسي",
    "azabot.serviceUber": "أوبر فيكس",
    "azabot.serviceErp": "نظام ERP",
    "azabot.fileAttached": "تم إرفاق ملف",
    "azabot.photoAttached": "تم إرفاق صورة العطل",
    "azabot.cameraError": "تعذر الوصول للكاميرا",
    "azabot.capture": "التقاط",
    "azabot.cancel": "إلغاء",
  },
  en: {
    // Navbar
    ...
    "otp.login.subtitle": "Enter your email to receive a verification code",
    "otp.login.btn": "Send Verification Code",
    "otp.login.sending": "Sending...",
    "otp.check.title": "Check Your Email",
    "otp.check.subtitle": "We sent a verification code to",
    "otp.check.btn": "Enter Verification Code",
    "otp.check.resend": "Resend Code",
    "otp.check.resent": "Code Resent",
    "otp.check.wrongEmail": "Wrong email? Go back and try again",
    "otp.verify.title": "Enter Verification Code",
    "otp.verify.subtitle": "We sent a code to your email",
    "otp.verify.btn": "Confirm",
    "otp.verify.verifying": "Verifying...",
    "otp.verify.resend": "Resend Code",
    "otp.verify.error": "Invalid code. Please try again.",
    ...
    "azabot.attachFile": "Attach file",
    "azabot.takePhoto": "Capture issue",
    "azabot.downloadChat": "Download chat",
    "azabot.clearChat": "Clear chat",
    "azabot.services": "Service links",
    "azabot.serviceMain": "Main website",
    "azabot.serviceUber": "UberFix",
    "azabot.serviceErp": "ERP System",
    "azabot.fileAttached": "File attached",
    "azabot.photoAttached": "Issue photo attached",
    "azabot.cameraError": "Cannot access camera",
    "azabot.capture": "Capture",
    "azabot.cancel": "Cancel",
  },
};
